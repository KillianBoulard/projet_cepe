...
base_dataset_test = base_dataset %>% left_join(DIST_MIN_COMM_STATION, by="code_insee")
...
### Etape 5.1 : Synthèse générale par code insee / par mois
