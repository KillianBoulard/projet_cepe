...
#base_dataset_full = base_dataset_full[x,]
...
#Ajout des données du mois précédent
base_dataset_full = base_dataset_full %>% 
...
#Ajout des données du même mois de l'année précédente
base_dataset_full = base_dataset_full %>% 
...
saveRDS(base_dataset_full, file = "base_dataset_full.rds")
```
